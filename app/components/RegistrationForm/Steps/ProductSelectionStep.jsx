        ...
        <div className={styles.stepContent}>
                    ...
                    <div className={styles.productGrid}>
                        <div
                            className={`${styles.productCard} ${
                                formData.selectedItems.journey ? styles.selected : ''
                            }`}
            ...
            {category?.workshop && (
                <section className={styles.productSection}>
                    ...
                    <div className={styles.productGrid}>
                        {category.workshop.map((workshop, index) => (
                            <div
                                key={index}
                                className={`${styles.productCard} ${
                                    formData.selectedItems.workshops.includes(workshop) ? styles.selected : ''
                                }`}
                    ...
                    <div className={styles.productGrid}>
                        {category.courses.map((course, index) => (
                            <div
                                key={index}
                                className={`${styles.productCard} ${
                                    formData.selectedItems.courses.includes(course) ? styles.selected : ''
                                }`}
                            ...
                            >
                                ...
                                {course.instructor && (
                                    <p className={styles.instructor}>Instrutor: {course.instructor}</p>
                                )}
            ...
            {category?.dayUse && (
                <section className={styles.productSection}>
                    ...
                    <div className={styles.productGrid}>
                        <div
                            className={`${styles.productCard} ${
                                formData.selectedItems.dayUse ? styles.selected : ''
                            }`}
