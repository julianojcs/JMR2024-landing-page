...
export async function useMongoDB() {
  ...
  if (!cached.promise) {
    const opts = {
      ...
      // minPoolSize: 5, // Manter pelo menos 5 conexões de socket
      // maxIdleTimeMS: 30000, // Fechar conexões após 30 segundos de inatividade
      // waitQueueTimeoutMS: 5000, // Timeout para obter conexão do pool
    };
